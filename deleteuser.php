...
<body >
  <div class="scrollmenu">
    ...
    <fieldset>
      <legend><u><strong>Client Details😁😀</strong></u></legend>
             <form action="process_deleteuser.php" method="post">
             <ul style="list-style-type:none;">

                  <li>
                      <label for="bID"><strong>Client Number    </strong></label>
                      <br>
                 ...
                 <li>
                     <label for="waiterF"><strong>Client First Name</strong></label>
                     <br>
                 ...
                 <li>
                     <label for="waiterL"><strong>Client Last Name</strong></label>
                     <br>
              ...
              <div style="text-align:center;">
                     ...
                     <button type="submit" class="button"><strong>Delete</strong></button>
