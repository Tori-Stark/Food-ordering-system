...
<body>
  ...
  <div class="scrollmenu">
   ...
   <p class="image">
    ...
    <fieldset>
      <legend><u><strong>Fill in Table details</strong></u></legend>
      <form action="process_bookingtable.php" method="post">
     <ul style="list-style-type:none;">
       <li>
           <label for="rID"><strong>Table number</strong></label><br>
       ...
       <li>
           <label for="rLocation"><strong>Table Location</strong></label><br>
      ...
      <li>
       ...
       <li>
            ...
            <input type="date" id="cDate" name="cDate"   size="30px"> </input>
       </li>
       <br>
       <br>
               ...
               <div style="text-align:center;">
                   <button type="submit" name="register" class="button"><strong>Book Table</strong></button>
