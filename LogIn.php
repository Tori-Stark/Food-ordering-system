...
<body >
  <div class="scrollmenu">
    ...
    <p class="logo">" The secret is at the table" &nbsp;&nbsp;🍹🍸</p> 
	  ...
	  <fieldset>
      <legend><u><strong>Log In Details😁😀</strong></u></legend>
             ...
             <ul style="list-style-type:none;">
                 ...
                 <li>
                     <label for="psd"><strong>Password:</strong></label>
                     <br>
                     
                     <input type="Password" id="psd" name="psd" size="30px">
                 </li>
                 <br>
              ...
              <div style="text-align:center;">
                     ...
                     <button type="submit" name="register" class="button"><strong>Log In</strong></button>
              ...
              <p class="account"> <strong>Don't have an account yet?</strong></p>
              <br><br>
             <div style="text-align:center;">
                  
                <a href="SignUp.php" class="button" > <strong>Sign Up</strong></a>
             </div>
